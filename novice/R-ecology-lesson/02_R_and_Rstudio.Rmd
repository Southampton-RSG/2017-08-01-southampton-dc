...
> * Create a R Project and understand how to organise files.
> * Know how to use the built-in RStudio help interface to search for more information on R functions.
> * Know how to seek help from the R user community.
...
powerful graphical visualisations and web apps. It therefore has a large community 
...
mailing lists and [Stack Overflow](https://stackoverflow.com/).
...
Let's start by learning about [RStudio](https://www.rstudio.com/), the
...
but this will open as soon as we create/edit a R script (or many other document types). *The script editor is where will be typing most of the time.*
...
R Studio provides a helpful set of tools to do this through its "Projects"
...
The console pane (in R Studio, the bottom left panel) is the place where R is
...
R Studio allows you to execute commands directly from the script editor by using
...
R Studio provides the <kbd>`Ctrl`</kbd> + <kbd>`1`</kbd> and <kbd>`Ctrl`</kbd> +
...
you're in R Studio and this happens, click inside the console window and press
...
* The person sitting next to you during the workshop. Don't hesitate to talk to
  your neighbour during the workshop, compare your answers, and ask for
  help. You might also be interested in organizing regular meetings following
  the workshop to keep learning from each others.
